import type { UnitValues } from "@/interfaces/units.interface";
...
const CreateModal = () => {
  ...
  // handlers
  const handleCreate = async (values: UnitValues) => {
    try {
      ...
      >
        ...
        >
          ...
          <div className="col-span-12 w-full grid grid-cols-2 items-center gap-4 mt-4">
            ...
            <Button type="primary" htmlType="submit" form="unit-form" size="large">
              {t("save")}
            </Button>
          </div>
        </Form>
